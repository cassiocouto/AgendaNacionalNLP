...
df = pd.read_excel("dados/potencial_com_temas.xlsx").drop_duplicates()
print(f"Quantidade de docentes no RS: {len(df)}")

#Passo 2: Gerar gráficos de tema_formacao_academica
gerar_grafico_quantidade_temas(df, "tema_formacao_academica", "Quantidade de docentes no RS por tema", "quantidade_tema_formacao_academica_potencial")
print("Tema Formação Acadêmica")
contar_temas(df, "tema_formacao_academica")

#Passo 3: Gerar gráficos de tema_projetos_desenvolvidos
gerar_grafico_quantidade_temas(df, "tema_projetos_desenvolvidos", "Projetos de docentes classificados tema", "quantidade_tema_projetos_desenvolvidos_potencial")
print("Tema Projetos Desenvolvidos")
contar_temas(df, "tema_projetos_desenvolvidos")

#Passo 4: Gerar gráficos de tema_producao_intelectual
gerar_grafico_quantidade_temas(df, "tema_producao_intelectual", "Produção intelectual de docentes classificados tema", "quantidade_tema_producao_intelectual_potencial")
print("Tema Produção Intelectual")
contar_temas(df, "tema_producao_intelectual")